...
object Seed : RoomDatabase.Callback() {
    override fun onCreate(db: SupportSQLiteDatabase) {
        db.apply {
            ...
            execSQL("INSERT into Pizza (uid, name, imageUrl, basePrice) VALUES ('a6041e38-3a4b-4573-8e57-28d1ee180310', 'Chili', 'https://bigoven-res.cloudinary.com/image/upload/t_recipe-256/pita-pizzas-vegan.jpg', 9.0);")
